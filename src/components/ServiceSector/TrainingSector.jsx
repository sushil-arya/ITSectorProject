        ...
        <div className="container py-5 pb-5">
          ...
          <TextMotion>
            <div
              ...
              style={{ maxWidth: 800 }}
            >
              <h4 className="text-primary">IT Traning</h4>
          ...
          <div className="row g-4">
            ...
            <motion.div
              ...
              <div className="feature-item p-4">
                ...
                <div className="p-4 mb-2">
                  <img src="../assets/img/artificial-intelligence.svg" alt="" height="150px" />
                </div>
            ...
            <motion.div className="col-md-6 col-lg-6 col-xl-4" ref={ref}
              ...
              <div className="feature-item p-4">
                ...
                <div className="p-4 mb-2">
                  <img src="../assets/img/machine-learning.svg" alt="" height="150px" />
                </div>
            ...
            <motion.div className="col-md-6 col-lg-6 col-xl-4" ref={ref}
              ...
              <div className="feature-item p-4">
                ...
                <div className="p-4 mb-2">
                  <img src="../assets/img/cloud-computing.svg" alt="" height="150px" />
                </div>
            ...
            <motion.div className="col-md-6 col-lg-6 col-xl-6" ref={ref}
              initial="hidden"
              animate={ isInView ? "visible" : "hidden"}
              transition={{ duration: 0.9, delay: 0.91, ease: 'easeInOut' }}
              variants={variants}>
              ...
              <div className="feature-item p-4">
                ...
                <div className="p-4 mb-2">
                  <img src="../assets/img/software-development-2.svg" alt="" height="150px" />
                </div>
            ...
            <motion.div className="col-md-6 col-lg-6 col-xl-6" ref={ref}
              initial="hidden"
              animate={ isInView ? "visible" : "hidden"}
              transition={{ duration: 0.94, delay: 0.99, ease: 'easeInOut' }}
              variants={variants}>
              ...
              <div className="feature-item p-4">
                ...
                <div className="p-4 mb-2">
                  <img src="../assets/img/application-development.svg" alt="" height="150px" />
                </div>
