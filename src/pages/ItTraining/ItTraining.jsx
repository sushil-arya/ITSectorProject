...
import TrainingSector from '../../components/ServiceSector/TrainingSector'
      ...
      <div className="container-fluid position-relative p-0">
        ...
        <div className="container-fluid bg-breadcrumb">
          <div className="container text-center py-5" style={{maxWidth: '900px'}}>
            ...
            <TextMotionTopBottom>
            <h4 className="text-white display-4 mb-4">IT Training Services</h4>
            </TextMotionTopBottom>
            ...
            <ol className="breadcrumb d-flex justify-content-center mb-0">
              ...
              <li className="breadcrumb-item active text-primary">IT Training</li>
            </ol> 
            </TextMotionBottomTop>   
          </div>
        </div>
